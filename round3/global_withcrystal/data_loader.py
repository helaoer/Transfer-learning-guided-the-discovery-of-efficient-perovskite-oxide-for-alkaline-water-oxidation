...
def data_loader(filepath="../cluster/overp_1_clusters.xlsx",x_index=[3,-2],y_label="overpotential (mV)",abo3_index=[0],clusters_index=-1,selected_clusters=[i for i in range(1000)],refit=True,scaler=StandardScaler()):
    x = []     
    y = []
    abo3 = []
    clusters = []
